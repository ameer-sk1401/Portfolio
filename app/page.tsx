      ...
      <div className="bg-black/20 backdrop-blur-md rounded-full px-6 py-3 border border-white/10">
        <div className="flex items-center space-x-8">
          ...
          <div className="flex space-x-6">
            {["Skills", "Experience", "Education", "Projects", "Contact"].map((item) => (
              <button
                key={item}
      ...
      <div className="flex-1 max-w-2xl">
        ...
        <div className="flex items-center space-x-4">
          <Button asChild className="bg-blue-500 hover:bg-blue-600 text-white rounded-full px-6 py-3">
            <a href={LINKS.linkedin} target="_blank" rel="noopener noreferrer" aria-label="Open LinkedIn profile">
              <Linkedin className="w-5 h-5" />
            </a>
          </Button>
          <Button asChild className="bg-blue-500 hover:bg-blue-600 text-white rounded-full px-6 py-3">
            <a href={LINKS.github} target="_blank" rel="noopener noreferrer" aria-label="Open GitHub profile">
  ...
  const experiences = [
    {
      ...
      technologies: ["Python", "ServiceNow", "REST APIs", "IoT", "Flow Designer", "UI Builder", "FSM", "Agile"],
    },
  ]
          ...
          >
            <div className="flex items-start space-x-6 mb-6">
              ...
              <div className="flex-1">
                ...
                <div className="mb-6">
                  ...
                  <ul className="space-y-2">
                    {exp.achievements.map((achievement, achIndex) => (
                      <li key={achIndex} className="text-white/80 text-sm leading-relaxed flex items-start">
                ...
                <div>
                  <h5 className="text-sm font-semibold text-white/60 mb-2">Technologies Learned / Worked on:</h5>
  ...
  const projects = [
    {
      ...
      techStack: ["Python", "Boto3", "AWS Lambda", "CloudWatch", "S3", "SNS", "IAM", "Cost Explorer"],
      icon: "☁️",
      github: "#",
      demo: "#",
    },
    {
      title: "CI/CD Pipeline for Serverless Application Using AWS CloudFormation",
      description:
      ...
      techStack: ["CloudFormation", "CodePipeline", "CodeCommit", "CodeBuild", "Lambda", "API Gateway", "DynamoDB"],
      icon: "🚀",
      github: "#",
      demo: "#",
    },
    {
      ...
      description:
        "Built a scalable real-time data streaming pipeline using Apache Kafka and PySpark to process and analyze high-volume event data. Implemented data transformations and aggregations that improved data processing efficiency by 50%.",
      techStack: ["Apache Kafka", "PySpark", "Python", "AWS EMR", "S3", "Airflow"],
      icon: "📊",
      github: "#",
      demo: "#",
    },
    {
      ...
      description:
        "Designed and implemented Infrastructure as Code (IaC) using Terraform to automate the provisioning of multi-tier AWS environments. Reduced infrastructure setup time by 70% and ensured consistency across development, staging, and production environments.",
      techStack: ["Terraform", "AWS", "EC2", "VPC", "RDS", "S3", "IAM", "CloudWatch"],
      icon: "🏗️",
      github: "#",
      demo: "#",
    },
    ...
    >
      <div className="w-full max-w-4xl mx-auto text-center">
        ...
        <div className="flex justify-center space-x-6 mb-12">
          <Button asChild variant="ghost" size="lg" className="text-white hover:text-blue-300">
            <a href={LINKS.linkedin} target="_blank" rel="noopener noreferrer" aria-label="Open LinkedIn profile">
          ...
          <Button asChild variant="ghost" size="lg" className="text-white hover:text-blue-300">
            <a href={LINKS.email} target="_blank" rel="noopener noreferrer" aria-label="Send email">
